...
setMethod("rstream.name", c("rstream.lecuyer"), 
          function(stream) { 
                  if (stream@is.packed) 
...
setReplaceMethod("rstream.name", c("rstream.lecuyer"), 
...
setMethod("rstream.antithetic", c("rstream.lecuyer"), 
          function(stream) {
                  if (stream@is.packed) 
...
setReplaceMethod("rstream.antithetic", c("rstream.lecuyer"),
                 function(stream, value) { 
...
setMethod("rstream.incprecision", c("rstream.lecuyer"), 
          function(stream) {
                  if (stream@is.packed) 
...
setReplaceMethod("rstream.incprecision", c("rstream.lecuyer"),
                 function(stream, value) { 
...
setMethod("rstream.resetsubstream", c("rstream.lecuyer"), 
          function(stream) { 
...
setMethod("rstream.nextsubstream", c("rstream.lecuyer"), 
          function(stream) { 
...
setMethod("rstream.reset", c("rstream.lecuyer"), 
          function(stream) { 
                  if (stream@is.packed) stop("Cannot reset PACKED Rstream") 
...
setMethod("rstream.clone", c("rstream.lecuyer"), 
          function(stream) { 
...
setReplaceMethod("rstream.packed", c("rstream.lecuyer"), 
                 function(stream, value) {
...
setMethod(".rstream.getRNG", c("rstream.lecuyer"), 
...
##    (internal method; not exported)
setMethod(".rstream.setRNG", c("rstream.lecuyer"), 
          function(stream) {
